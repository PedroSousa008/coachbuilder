...
export const CLOUD_SERVER_UNAVAILABLE_MESSAGE =
  "Cloud inativa: falta SESSION_SECRET ou ligação à base de dados. Na Vercel: liga Vercel Postgres ao projeto (ou define DATABASE_URL) + SESSION_SECRET (≥16 caracteres) + NEXT_PUBLIC_ENABLE_CLOUD_SYNC=true, e faz Redeploy.";
